 ...
 */
public class SwarmAgent extends FieldAgent {
    public static Position swarmObjective;
    private static List<SwarmAgent> agents = new ArrayList<SwarmAgent>();
    ...
    private void ScoutMovement() {
        if (panel_stats.calcularTiempo() - currentRepTime >= reproduceTimer
