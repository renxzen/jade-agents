...
/**
 * @author G5: Juan Costa
 */
public class ShipAgent extends FieldAgent {
    // Explore
    // Return
    // Stay
    // Emergency
    ...
    private static List<ShipAgent> agents = new ArrayList<ShipAgent>();
    ...
    private void CheckFoodSource() {
        ...
        if (source != null && source.position.getY() <= MAX_Y) {
            ...
            if (isNew) {
                ...
                // System.out.println(foundFood +"| COMIDA: "+source.position + " | " +
                // panel_stats.calcularTiempo());
            }
        }
    }
