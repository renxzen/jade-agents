...
/**
 * @author G9: Peralta & Chavez
 */
public class CombiOrionAgent extends FieldAgent {
                            ...
                            new ActionListener() {
                                ...
                                public void actionPerformed(ActionEvent evt) {
                                    ...
                                    for (FieldUnity ally : getLocal().species.members.values()) {
                                        if (!ally.equals(getLocal())) cantidad += 1;
                                    }
                                    if (cantidad < 6) {
                    ...
                    new Timer(
                            ...
                            new ActionListener() {
                                ...
                                public void actionPerformed(ActionEvent e) {
                                    ...
                                    if (position1 != null) {
                                        if (getLocal().position.distance(position1) < 100
                                                && ((int) (Math.random() * (10 - 0)) <= 2)
    ...
    protected void reproduce() {
        if (getLocal().species.getStock() > 60) {
            ...
            if (position1 == null) {
                unity.position =
                        new Position(
                                getLocal().position.getX() + 50, getLocal().position.getY() + 50);
            } else {
