                        ...
                        switch (content) {
                            ...
                            case "RESERVE":
                                if (customers.size() < capacity) {
                                    ...
                                    System.out.println(String.format("[%s] Accepted reservation from %s. %d/%d.", getLocalName(), sender, customers.size(), capacity));
                                }
                                else {
                                    reply.setPerformative(ACLMessage.REJECT_PROPOSAL); 
                                    reply.setContent("REJECTED");
                                    System.out.println(String.format("[%s] Rejected reservation from %s. %d/%d.", getLocalName(), sender, customers.size(), capacity));
                                }   
                                break;
                            case "NEW_NIGHT":
                                System.out.println(String.format("[%s] Ready with %d slots", getLocalName(), capacity));
